...
import { ICON_PURPLE_ALL_ORDERS, ICON_PURPLE_MY_ORDERS, ICON_PURPLE_MAP, ICON_PURPLE_STATISTICS, ICON_PURPLE_PROFILE, ICON_PURPLE_SETTINGS, ICON_PURPLE_SUPPORT } from '../../../public';
